...
const singleBlog = blogs.slice(0, 1)
...
describe('favorite', () => {
  test('favorite blog of all blogs', () => {
...
describe('most prolific author', () => {
  test('most prolific author of all blogs', () => {
    const result = listHelper.mostProlificAuthor(blogs)
